...
import (
	...
	versionedscheme "github.com/kubelight/kubelight/pkg/client/clientset/versioned/scheme"
	client "github.com/kubelight/kubelight/pkg/client/injection/client"
	backend "github.com/kubelight/kubelight/pkg/client/injection/informers/kubelight/v1alpha1/backend"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "backend-controller"
	defaultFinalizerName       = "backends.kubelight.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	backendInformer := backend.Get(ctx)

	lister := backendInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "kubelight.dev.Backend"),
	)
