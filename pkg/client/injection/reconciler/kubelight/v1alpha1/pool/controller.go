...
import (
	...
	pool "github.com/kubelight/kubelight/pkg/client/injection/informers/kubelight/v1alpha1/pool"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "pool-controller"
	defaultFinalizerName       = "pools.kubelight.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "kubelight.dev.Pool"),
	)
