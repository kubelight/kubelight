...
var backendsResource = schema.GroupVersionResource{Group: "kubelight.dev", Version: "v1alpha1", Resource: "backends"}

var backendsKind = schema.GroupVersionKind{Group: "kubelight.dev", Version: "v1alpha1", Kind: "Backend"}
