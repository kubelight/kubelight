...
import (
	...
	scheme "github.com/kubelight/kubelight/pkg/client/clientset/versioned/scheme"
...
func newPools(c *KubelightV1alpha1Client, namespace string) *pools {
	return &pools{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pools) UpdateStatus(ctx context.Context, pool *v1alpha1.Pool, opts v1.UpdateOptions) (result *v1alpha1.Pool, err error) {
	result = &v1alpha1.Pool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pools").
