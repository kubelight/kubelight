...
import (
	...
	kubelightv1alpha1 "github.com/kubelight/kubelight/pkg/apis/kubelight/v1alpha1"
	versioned "github.com/kubelight/kubelight/pkg/client/clientset/versioned"
	internalinterfaces "github.com/kubelight/kubelight/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kubelight/kubelight/pkg/client/listers/kubelight/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubelightV1alpha1().Backends(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubelightV1alpha1().Backends(namespace).Watch(context.TODO(), options)
			},
		},
		&kubelightv1alpha1.Backend{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backendInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubelightv1alpha1.Backend{}, f.defaultInformer)
}
