	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubelightV1alpha1().Pools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubelightV1alpha1().Pools(namespace).Watch(context.TODO(), options)
			},
		},
		&kubelightv1alpha1.Pool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *poolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubelightv1alpha1.Pool{}, f.defaultInformer)
}
